class VisitorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @visitor.save
        ContactMailer.message_email(@visitor).deliver_later
        ContactMailer.send_message_email(@visitor).deliver_later
  ...
  private
    ...
    def visitor_params
      params.require(:visitor).permit(:first_name, :last_name, :email, :comment)
    end
end
