...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { comment: @visitor.comment, email: @visitor.email, first_name: @visitor.first_name, last_name: @visitor.last_name } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { comment: @visitor.comment, email: @visitor.email, first_name: @visitor.first_name, last_name: @visitor.last_name } }
